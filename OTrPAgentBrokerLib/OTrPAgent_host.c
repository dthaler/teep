...
oe_result_t create_OTrPAgent_enclave(const char* enclave_name, oe_enclave_t** out_enclave)
{
...
#endif
    result = oe_create_OTrPAgent_enclave(
        enclave_name,
...
{
    oe_enclave_t* enclave = NULL;
    oe_result_t result = create_OTrPAgent_enclave(
#ifdef OE_USE_OPTEE
