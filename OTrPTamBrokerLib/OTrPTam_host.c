...
oe_result_t create_OTrPTam_enclave(const char* enclave_name, oe_enclave_t** out_enclave)
{
...
#endif
    result = oe_create_OTrPTam_enclave(
        enclave_name,
...
{
    oe_enclave_t* enclave = NULL;
    oe_result_t result = create_OTrPTam_enclave(
#ifdef OE_USE_OPTEE
