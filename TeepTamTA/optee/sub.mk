...
../OTrPTamTA2_t.c: ../OTrPTamTA2.edl
	$(OEEDGER8R) --trusted --trusted-dir .. --search-path "$(OE_SDK_INC_PATH)" ../OTrPTamTA2.edl

../OTrPTamTA2_t.h: ../OTrPTamTA2.edl
	$(OEEDGER8R) --trusted --trusted-dir .. --search-path "$(OE_SDK_INC_PATH)" ../OTrPTamTA2.edl

# Add the c file generated from your EDL file here
srcs-y             += ../OTrPTamTA2_t.c
